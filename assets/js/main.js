...
(function ($) {
  ...
  // Timeline.
  $(".timeline > .timeline-item").scrollex({
    mode: "middle",
    top: "-20vh",
    bottom: "-20vh",
    initialize: function () {
      // Deactivate timeline item.
      $(this).addClass("inactive");
    },
    enter: function () {
      // Activate timeline item by adding .visible class.
      $(this).removeClass("inactive").addClass("visible");
    },
  });

  // Project Grid Animation
  $(".project-grid > .project-item").scrollex({
    mode: "middle",
    top: "-20vh",
    bottom: "-20vh",
    initialize: function () {
      // Deactivate project item.
      $(this).addClass("inactive");
    },
    enter: function () {
